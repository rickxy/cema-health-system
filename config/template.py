...
THEME_VARIABLES = {
    "creator_name": "Ricky",
    "creator_url": "https://ricky.com/",
    "template_name": "CEMA HEALTH SYSTEM",
    "template_suffix": "",
    "template_version": "1.0.0",
    "template_free": False,
    "template_description": "CEMA HEALTH SYSTEM is a modern, clean and fully responsive admin template built with Bootstrap 5, Django, HTML, CSS, jQuery, and JavaScript. It has a huge collection of reusable UI components and integrated with the latest jQuery plugins. It can be used for all types of web applications like custom admin panel, project management system, admin dashboard, Backend application or CRM.",
    ...
    "live_preview": "https://demos.pixinvent.com/CEMA HEALTH SYSTEM-html-admin-template/html/vertical-menu-template/",
    ...
    "documentation": "https://demos.pixinvent.com/CEMA HEALTH SYSTEM -html-admin-template/documentation/django-introduction.html",
    "changelog": "https://demos.pixinvent.com/CEMA HEALTH SYSTEM/changelog.html",
    "git_repository": "CEMA HEALTH SYSTEM-html-django-admin-template",
